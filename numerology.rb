...
def numerology_message(birthpath_number)
...
when  3
	message = 'Your numerology number is 3. Number Three is a sociable, friendly, and outgoing vibration. Kind, positive, and optimistic, Threes enjoy life and have a good sense of humor. Ruled by Jupiter.'
when  4
...
when  9
	...
	message = 'Hmm, looks like there\'s been an error!'
end
end

puts "What is your birthdate? Please enter the date in MMDDYYYY format."
	birthdate = gets
